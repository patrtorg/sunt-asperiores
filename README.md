...
Looking for [`Observer@1.x`](https://github.com/patrtorg/sunt-asperiores/tree/v1.7.6)?
...
```html
<script src="https://unpkg.com/@patrtorg/sunt-asperiores/dist/main.js"></script>
```

> `4.4` kB min + gz | `13.9` KB min [↗](https://bundlephobia.com/package/@patrtorg/sunt-asperiores)
...
```bash
npm i @patrtorg/sunt-asperiores
```

```js
// Import
import Observer from '@patrtorg/sunt-asperiores';;
```
